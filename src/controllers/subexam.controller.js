...
export const createSubExam = async (req, res, next) => {
    try {
...
export const getSubExamsBySubjectAndTerm = async (req, res, next) => {
    try {
        const { subjectId, termId } = req.params;
        const subExams = await subExamService.getSubExamsBySubjectAndTerm(subjectId, termId);
...
export const updateSubExam = async (req, res, next) => {
    try {
        const subExam = await subExamService.updateSubExam(req.params.id, req.body);
...
export const deleteSubExam = async (req, res, next) => {
    try {
...
//# sourceMappingURL=subexam.controller.js.map