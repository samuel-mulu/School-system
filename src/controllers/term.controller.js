...
export const getTerms = async (req, res, next) => {
    try {
        ...
        const terms = await termService.getTerms(academicYearId);
...
export const closeTerm = async (req, res, next) => {
    try {
...
export const openTerm = async (req, res, next) => {
    try {
...
export const activateTerm = async (req, res, next) => {
    try {
