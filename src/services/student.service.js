...
export const getStudentById = async (id, userId, userRole) => {
...
export const assignStudentToClass = async (studentId, classId, reason = 'initial assignment') => {
...
export const transferStudent = async (studentId, newClassId, reason = 'transfer') => {
    // Verify student exists
    const student = await prisma.student.findUnique({
        where: { id: studentId },
    });
