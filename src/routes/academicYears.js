...
// Routes
router.post('/', authenticate, requireRegistrarOrOwner, validate(createAcademicYearSchema), academicYearController.createAcademicYear);
...
router.patch('/:id', authenticate, requireRegistrarOrOwner, validate(updateAcademicYearSchema), academicYearController.updateAcademicYear);
router.post('/:id/activate', authenticate, requireRegistrarOrOwner, academicYearController.activateAcademicYear);
router.post('/:id/close', authenticate, requireRegistrarOrOwner, academicYearController.closeAcademicYear);
